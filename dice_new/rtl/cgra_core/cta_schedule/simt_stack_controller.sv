...
module simt_stack_controller #(
    ...
    input logic [dice_pkg::DICE_ADDR_WIDTH-1:0] update_next_pc,  // No divergence: next PC, With divergence: branch taken PC
    ...
    input logic [dice_pkg::DICE_ADDR_WIDTH-1:0] branch_not_taken_pc,
    input logic [dice_pkg::DICE_ADDR_WIDTH-1:0] branch_reconvergence_pc,
    ...
    input logic [dice_pkg::DICE_ADDR_WIDTH-1:0] init_pc,
    input logic [dice_pkg::DICE_ADDR_WIDTH-1:0] init_reconvergence_pc,
    ...
    output logic [NUM_STACK-1:0][dice_pkg::DICE_ADDR_WIDTH-1:0] stack_top_next_pc,
    output logic [NUM_STACK-1:0][dice_pkg::DICE_ADDR_WIDTH-1:0] stack_top_reconvergence_pc,
  ...
  logic [dice_pkg::DICE_ADDR_WIDTH-1:0] update_next_pc_reg;
  logic [NUM_STACK*THREAD_WIDTH-1:0] predicate_regs_value_reg;
  logic [dice_pkg::DICE_ADDR_WIDTH-1:0] branch_not_taken_pc_reg;
  logic [dice_pkg::DICE_ADDR_WIDTH-1:0] branch_reconvergence_pc_reg;

  // Registers for init operation
  logic [dice_pkg::DICE_ADDR_WIDTH-1:0] init_pc_reg;
  logic [dice_pkg::DICE_ADDR_WIDTH-1:0] init_reconvergence_pc_reg;
  ...
  logic [dice_pkg::DICE_ADDR_WIDTH-1:0] stack_push_next_pc[NUM_STACK];
  logic [dice_pkg::DICE_ADDR_WIDTH-1:0] stack_push_reconvergence_pc[NUM_STACK];
  logic [THREAD_WIDTH-1:0] stack_push_active_mask[NUM_STACK];
  logic [dice_pkg::DICE_ADDR_WIDTH-1:0] stack_top_next_pc_int[NUM_STACK];
  logic [dice_pkg::DICE_ADDR_WIDTH-1:0] stack_top_reconvergence_pc_int[NUM_STACK];
  ...
  logic [dice_pkg::DICE_ADDR_WIDTH-1:0] new_top_pc_reg;
  logic [dice_pkg::DICE_ADDR_WIDTH-1:0] new_top_reconvergence_pc_reg;
  logic [NUM_STACK*THREAD_WIDTH-1:0] new_top_active_mask_reg;
  logic [dice_pkg::DICE_ADDR_WIDTH-1:0] push_pc_1_reg, push_pc_2_reg;
  logic [dice_pkg::DICE_ADDR_WIDTH-1:0] push_reconvergence_pc_1_reg, push_reconvergence_pc_2_reg;
  ...
  always_comb begin
    ...
    case (hw_cta_size_reg)
      2'b00:
      effective_predicate = {
        {(NUM_STACK - 1) * THREAD_WIDTH{1'b0}}, predicate_regs_value_reg[THREAD_WIDTH-1:0]
      };
      2'b01:
      effective_predicate = {
        {(NUM_STACK - 2) * THREAD_WIDTH{1'b0}}, predicate_regs_value_reg[2*THREAD_WIDTH-1:0]
      };
      ...
      if (current_state == READ_TOP && combined_stack_out_valid) begin
        ...
        if (need_modify_top_next) begin
          $display(
              ...
              !update_with_divergence_reg ? update_next_pc_reg : all_taken ? update_next_pc_reg : all_not_taken ? branch_not_taken_pc_reg : branch_reconvergence_pc_reg);
        end
      end
    end
  end
