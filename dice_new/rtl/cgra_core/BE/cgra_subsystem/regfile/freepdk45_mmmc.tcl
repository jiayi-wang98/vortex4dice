create_library_set -name SS.setup_set -timing [list /data/eda_tools/pdk/freepdk-45nm/stdcells-wc.lib \
                                                /data/amanoj3/vortex4dice/dice_new/rtl/cgra_core/cgra_subsystem/regfile/temp/sram_512x32_SS_1p0V_25C.lib]
...
create_library_set -name FF.hold_set -timing [list /data/eda_tools/pdk/freepdk-45nm/stdcells-bc.lib \
                                                /data/amanoj3/vortex4dice/dice_new/rtl/cgra_core/cgra_subsystem/regfile/temp/sram_512x32_FF_1p0V_25C.lib]
...
create_library_set -name TT.extra_set -timing [list /data/eda_tools/pdk/freepdk-45nm/stdcells.lib \
                                                /data/amanoj3/vortex4dice/dice_new/rtl/cgra_core/cgra_subsystem/regfile/temp/sram_512x32_TT_1p1V_25C.lib]
...
read_physical -lef { \
    ...
    /data/amanoj3/vortex4dice/dice_new/rtl/cgra_core/cgra_subsystem/regfile/temp/sram_512x32.lef
}