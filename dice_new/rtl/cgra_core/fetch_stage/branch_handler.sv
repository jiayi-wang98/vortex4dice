...
module branch_handler #(
    ...
    // Update Info
    output logic [NUM_STACK*THREAD_WIDTH-1:0] predicate_regs_value_o,
    output logic [              PC_WIDTH-1:0] branch_not_taken_pc_o,
    output logic [              PC_WIDTH-1:0] branch_reconvergence_pc_o,
    // Control Info
    output logic                              update_with_divergence_o,
    output logic [              PC_WIDTH-1:0] update_next_pc_o,
    ...
    // Jump Targets
    logic [PC_WIDTH-1:0] jump_target_pc;
    logic [PC_WIDTH-1:0] reconv_target_pc;
    ...
    typedef struct packed {
        ...
        logic                            neg_pred;
        logic [PC_WIDTH-1:0]             taken_pc;
        logic [PC_WIDTH-1:0]             not_taken_pc;
    ...
    always_comb begin
        ...
        if (grant_background) begin
            ...
            if (update_ready_i) begin
                ...
                predicate_regs_value_o[THREAD_WIDTH-1:0] =
        ...
        // Foreground Update (Only if resolved immediately)
