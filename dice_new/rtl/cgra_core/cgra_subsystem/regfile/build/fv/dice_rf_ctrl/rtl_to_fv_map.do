...
# Generated on: Sun Feb 22 12:02:55 PST 2026 (Sun Feb 22 20:02:55 UTC 2026)
...
set logfile fv/dice_rf_ctrl/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/dice_rf_ctrl -revised fv_map -use_rtl_names
...
set env(CDN_SYNTH_ROOT) "/data/eda_tools/cadence/DDI251/GENUS251/tools.lnx86"
set CDN_SYNTH_ROOT      "/data/eda_tools/cadence/DDI251/GENUS251/tools.lnx86"
set env(CW_DIR) "/data/eda_tools/cadence/DDI251/GENUS251/tools.lnx86/lib/chipware"
set CW_DIR      "/data/eda_tools/cadence/DDI251/GENUS251/tools.lnx86/lib/chipware"
set lec_version_required "21.20249"
if { ($lec_version < $lec_version_required) &&
    [file exists /data/eda_tools/cadence/DDI251/GENUS251/tools.lnx86/lib/chipware/old_encrypt_sim]} {
    set env(CW_DIR_SIM) "/data/eda_tools/cadence/DDI251/GENUS251/tools.lnx86/lib/chipware/old_encrypt_sim"
    set CW_DIR_SIM      "/data/eda_tools/cadence/DDI251/GENUS251/tools.lnx86/lib/chipware/old_encrypt_sim"
} else {
    set env(CW_DIR_SIM) "/data/eda_tools/cadence/DDI251/GENUS251/tools.lnx86/lib/chipware/sim"
    set CW_DIR_SIM      "/data/eda_tools/cadence/DDI251/GENUS251/tools.lnx86/lib/chipware/sim"
}
...
add_notranslate_modules -library -both sram_512x32
# ILM modules: 

add_search_path . /data/eda_tools/cadence/DDI251/GENUS251/tools.lnx86/lib/tech -library -both
read_library -liberty -both \
    ...
    /data/eda_tools/pdk/freepdk-45nm/stdcells-wc.lib
...
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -sv09 -f src.f
elaborate_design -golden -root {dice_rf_ctrl} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/dice_rf_ctrl/fv_map.v.gz
elaborate_design -revised -root {dice_rf_ctrl}
...
add_module_attribute {dice_rf_ctrl} -pipeline_retime -both
add_noblack_box {dice_rf_ctrl} -submodules -both
...
set_analyze_option -mapping_file fv/dice_rf_ctrl/fv_map.map.do
...
set_system_mode lec
write_compared_points noneq.compared_points.dice_rf_ctrl.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.dice_rf_ctrl.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.dice_rf_ctrl.rtl.fv_map.rpt
