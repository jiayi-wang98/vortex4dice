// =============================================================================
// FILE: tcu_out_item.svh
// =============================================================================
// DESCRIPTION:
//   UVM sequence item representing a coalesced output command generated by the
//   Temporal Coalescing Unit (TCU). Used by the monitor and scoreboard for
//   collecting and comparing DUT outputs.
// =============================================================================
// =============================================================================
...
class tcu_out_item extends uvm_sequence_item;
  ...
  // Output command fields as observed on the DUT interface.
  bit [3:0]  block_id;
  bit [9:0]  base_tid;
  bit [7:0]  tid_bitmap;
  bit        write_enable;
  ...
  // Human-readable summary for logs and comparisons
