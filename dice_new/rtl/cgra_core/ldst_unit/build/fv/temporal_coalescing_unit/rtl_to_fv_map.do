...
# Generated on: Mon Feb 23 17:24:26 PST 2026 (Tue Feb 24 01:24:26 UTC 2026)
...
set logfile fv/temporal_coalescing_unit/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/temporal_coalescing_unit -revised fv_map -use_rtl_names
...
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -sv09 -f filelist.f
elaborate_design -golden -root {temporal_coalescing_unit} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/temporal_coalescing_unit/fv_map.v.gz
elaborate_design -revised -root {temporal_coalescing_unit}
...
add_module_attribute {temporal_coalescing_unit} -pipeline_retime -both
add_noblack_box {temporal_coalescing_unit} -submodules -both
...
set_analyze_option -mapping_file fv/temporal_coalescing_unit/fv_map.map.do
...
set_system_mode lec
write_compared_points noneq.compared_points.temporal_coalescing_unit.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.temporal_coalescing_unit.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.temporal_coalescing_unit.rtl.fv_map.rpt
