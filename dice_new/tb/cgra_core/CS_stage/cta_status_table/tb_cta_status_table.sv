// =============================================================================
// Testbench: tb_cta_status_table.sv (simplified happy-path)
// =============================================================================
...
module tb_cta_status_table;
  ...
  initial begin
    ...
    $display("tb_cta_status_table (happy-path)");
    ...
    assert (cta_status_o[0].unresolved_control_divergence == 1'b1)
      else $fatal(1, "unresolved_control_divergence not set");
    ...
    assert (cta_status_o[0].has_pending_eblock == 1'b1)
      else $fatal(1, "has_pending_eblock not set");
    ...
    assert (cta_status_o[0].unresolved_control_divergence == 1'b0)
      else $fatal(1, "unresolved_control_divergence not cleared");
    ...
    assert (cta_status_o[0].has_pending_eblock == 1'b0)
      else $fatal(1, "has_pending_eblock not cleared");
