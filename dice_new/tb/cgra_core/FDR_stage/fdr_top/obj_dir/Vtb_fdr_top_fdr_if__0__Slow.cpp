...
VL_ATTR_COLD void Vtb_fdr_top_fdr_if___ctor_var_reset(Vtb_fdr_top_fdr_if* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtb_fdr_top_fdr_if___ctor_var_reset\n"); );
    ...
    VL_SCOPED_RAND_RESET_W(790, vlSelf->data, __VscopeHash, 10363016170300574568ull);
