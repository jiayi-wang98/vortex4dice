...
void VVX_define_fdr_if___act_comb__TOP__tb_fdr_top__DOT__fdr_if__0(VVX_define_fdr_if* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          VVX_define_fdr_if___act_comb__TOP__tb_fdr_top__DOT__fdr_if__0\n"); );
...
void VVX_define_fdr_if___act_comb__TOP__tb_fdr_top__DOT__fdr_if__1(VVX_define_fdr_if* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          VVX_define_fdr_if___act_comb__TOP__tb_fdr_top__DOT__fdr_if__1\n"); );
    VVX_define__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
void VVX_define_fdr_if___nba_comb__TOP__tb_fdr_top__DOT__fdr_if__0(VVX_define_fdr_if* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          VVX_define_fdr_if___nba_comb__TOP__tb_fdr_top__DOT__fdr_if__0\n"); );
    VVX_define__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Locals
    VlWide<5>/*159:0*/ __Vtemp_10;
...
std::string VL_TO_STRING(const VVX_define_fdr_if* obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          VVX_define_fdr_if::VL_TO_STRING\n"); );
    // Body
