...
VL_ATTR_COLD void Vtb_fdr_top_cta_sched_if___ctor_var_reset(Vtb_fdr_top_cta_sched_if* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtb_fdr_top_cta_sched_if___ctor_var_reset\n"); );
